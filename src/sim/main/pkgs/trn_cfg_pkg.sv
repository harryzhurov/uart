...
parameter int send_del_exist_rx   = 12;       // probability of delay existance before data sending         \
parameter int rden_del_exist_rx   = 30;       // probability of delay existance before rx_rden flag sending  > (%)
