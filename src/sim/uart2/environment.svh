...
class Environment;
    ...
    function new(virtual uart_if uif);
        ...
        gen = new(gen2drv_tx,gen2drv_rx,gen2scb_tx,gen2scb_rx,gen2mnt_rx,uif);
        drv = new(gen2drv_tx,gen2drv_rx,uif);
        mnt = new(mnt2scb_tx,mnt2scb_rx,gen2mnt_rx,uif);
        scb = new(gen2scb_tx,gen2scb_rx,mnt2scb_tx,mnt2scb_rx,uif);
